const Blog = () => {
    return (
        <div className="min-h-screen mx-16 my-20 grid grid-cols-1 gap-y-8">
            <div className="mx-3 bg-gray-700 rounded-md px-4 py-6 text-slate-300 shadow-md grid grid-cols-1 gap-y-2">
                <h2 className="text-xl font-bold text-sky-300 mb-4">
                    1. What is an access token and refresh token? How do they work and where should
                    we store them on the client-side?
                </h2>
                <p className="mx-7">
                    Access token and refresh token are commonly used in authentication systems to
            ...
            <div className="mx-3 bg-gray-700 rounded-md px-4 py-6 text-slate-300 shadow-md grid grid-cols-1 gap-y-2">
                ...
                <p className="mx-7">
                    SQL (Structured Query Language) and NoSQL (Not Only SQL) databases differ in
            ...
            <div className="mx-3 bg-gray-700 rounded-md px-4 py-6 text-slate-300 shadow-md grid grid-cols-1 gap-y-2">
                ...
                <p className="mx-7">
                    ...
                    It provides a simple yet powerful set of features for building web applications
                    and APIs. With Express.js, developers can handle HTTP requests, define routes,
                    manage middleware, and implement various functionalities required for web
                    development. It follows a minimalist approach, allowing developers to structure
                    their applications as per their needs.
                </p>
                <p className="mx-7">
            ...
            <div className="mx-3 bg-gray-700 rounded-md px-4 py-6 text-slate-300 shadow-md grid grid-cols-1 gap-y-2">
                ...
                <p className="mx-7">
                    MongoDB's aggregate is a powerful framework used for data aggregation and
